...
Partial Class FormMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.ImageList1.Images.SetKeyName(136, "40px-Boots_of_Travel_2.png")
        Me.ImageList1.Images.SetKeyName(137, "40px-Crimson_Guard.png")
        Me.ImageList1.Images.SetKeyName(138, "40px-Enchanted_Mango.png")
        Me.ImageList1.Images.SetKeyName(139, "40px-Faerie_Fire.png")
        Me.ImageList1.Images.SetKeyName(140, "40px-Glimmer_Cape.png")
        Me.ImageList1.Images.SetKeyName(141, "40px-Guardian_Greaves.png")
        Me.ImageList1.Images.SetKeyName(142, "40px-Lotus_Orb.png")
        Me.ImageList1.Images.SetKeyName(143, "40px-Moon_Shard.png")
        Me.ImageList1.Images.SetKeyName(144, "40px-Octarine_Core.png")
        Me.ImageList1.Images.SetKeyName(145, "40px-Silver_Edge.png")
        Me.ImageList1.Images.SetKeyName(146, "40px-Solar_Crest.png")
        Me.ImageList1.Images.SetKeyName(147, "40px-Aether_Lens.png")
        Me.ImageList1.Images.SetKeyName(148, "40px-Blight_Stone.png")
        Me.ImageList1.Images.SetKeyName(149, "40px-Bloodthorn.png")
        Me.ImageList1.Images.SetKeyName(150, "40px-Dragon_Lance.png")
        Me.ImageList1.Images.SetKeyName(151, "40px-Echo_Sabre.png")
        Me.ImageList1.Images.SetKeyName(152, "40px-Hurricane_Pike.png")
        Me.ImageList1.Images.SetKeyName(153, "40px-Infused_Raindrop.png")
        Me.ImageList1.Images.SetKeyName(154, "40px-Iron_Talon.png")
        Me.ImageList1.Images.SetKeyName(155, "40px-Tome_of_Knowledge.png")
        Me.ImageList1.Images.SetKeyName(156, "40px-Wind_Lace.png")
        '
        'ListViewArcane
        '
