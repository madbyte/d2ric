...
#Region "Items"
    ...
    Public Function RenameItem(ByVal item_name As String) As String
        ...
        Select Case True
            ...
            Case item_name2 Like "*item_battle_fury"
                rename_item_name = "Battle Fury"
            ...
            Case item_name2 Like "*item_blood_stone"
                rename_item_name = "Bloodstone"
            ...
            Case item_name2 Like "*item_ghost_scepter"
                rename_item_name = "Ghost Scepter"
            ...
            Case item_name2 Like "*item_hand_midas"
                rename_item_name = "Hand of Midas"
            ...
            Case item_name2 Like "*item_shadow_blade"
                rename_item_name = "Shadow Blade"
            ...
            Case item_name2 Like "*item_manta_style"
                rename_item_name = "Manta Style"
            ...
            Case item_name2 Like "*item_necronomicon_1"
                rename_item_name = "Necronomicon 1"
            ...
            Case item_name2 Like "*item_necromonicon_3"
                rename_item_name = "Necronomicon 3"
            ...
            Case item_name2 Like "*item_refresher_orb"
                rename_item_name = "Refresher Orb"
            ...
            Case item_name2 Like "*item_eye_of_skadi"
                rename_item_name = "Eye of Skadi"
            ...
            Case item_name2 Like "*item_sages_mask"
                rename_item_name = "Sage's Mask"
            ...
            Case item_name2 Like "*item_spherer"
                rename_item_name = "Linken's Sphere"
            ...
            Case item_name2 Like "*item_travel_boots_1"
                rename_item_name = "Boots of Travel"
            Case item_name2 Like "*item_boots_of_travel_1"
                rename_item_name = "Boots of Travel"
            ...
            Case item_name2 Like "*item_veil_of_dicord"
                rename_item_name = "Veil of Discord"
            ...
            Case item_name2 Like "*item_crimson_time"
                rename_item_name = "Crimson Guard"
            Case item_name2 Like "*item_moon_shard"
                rename_item_name = "Moon Shard"
            Case item_name2 Like "*item_moonshard"
                rename_item_name = "Moon Shard"
